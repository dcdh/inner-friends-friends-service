...
public final class GetFriendOfFriendCommand implements UseCaseCommand<FriendOfFriendId> {
    ...
    public GetFriendOfFriendCommand(final FriendId friendId,
    ...
    @Override
    public FriendOfFriendId identifier() {
        return friendOfFriendId;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GetFriendOfFriendCommand)) return false;
        final GetFriendOfFriendCommand that = (GetFriendOfFriendCommand) o;
    ...
    public String toString() {
        return "GetFriendOfFriendCommand{" +
                "friendId=" + friendId +
