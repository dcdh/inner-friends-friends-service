...
public class TopicConsumer {
    ...
    public TopicConsumer(@ConfigProperty(name = "kafka.exposed.port.9092") final Integer kafkaExposedPort9092) {
        ...
        if (!kafkaConsumer.listTopics().containsKey("Friend.events")) {
            throw new IllegalStateException("topic Friend.events not present and can't be subscribe");
        }
        kafkaConsumer.assign(List.of(new TopicPartition("Friend.events", 0)));
    }
